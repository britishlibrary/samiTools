...
""")
    ...
    for file in os.listdir(input_path):
        ...
        if ext in ['.xml', '.prn'] or file.endswith(SAMI_SUFFICES) or any(f in root for f in PRIMO_FLAGS):
            ...
            # Open input file
            ifile = io.open(os.path.join(input_path, file), mode='r', encoding='utf-8', errors='replace')
            ...
            if split:
                ...
                for record in reader:
                    ...
                    if xml:
                        current_file = io.open(filename, 'w', encoding='utf-8', errors='replace')
                        if header:
                        ...
                        current_file = io.open(filename, mode='wb')
